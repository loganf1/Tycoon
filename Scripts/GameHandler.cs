...
public class GameHandler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*
        Toggle t2 = GameObject.Find("Toggle2").GetComponent<Toggle>();
        Toggle t3 = GameObject.Find("Toggle3").GetComponent<Toggle>();
        Toggle t4 = GameObject.Find("Toggle4").GetComponent<Toggle>();
        Toggle t5 = GameObject.Find("Toggle5").GetComponent<Toggle>();
        Toggle t6 = GameObject.Find("Toggle6").GetComponent<Toggle>();
        Toggle t7 = GameObject.Find("Toggle7").GetComponent<Toggle>();
        Toggle t8 = GameObject.Find("Toggle8").GetComponent<Toggle>();
        Toggle t9 = GameObject.Find("Toggle9").GetComponent<Toggle>();
        Toggle t10 = GameObject.Find("Toggle10").GetComponent<Toggle>();
        Toggle t11 = GameObject.Find("Toggle11").GetComponent<Toggle>();
        Toggle t12 = GameObject.Find("Toggle12").GetComponent<Toggle>();
        Toggle t13 = GameObject.Find("Toggle13").GetComponent<Toggle>();
        Toggle t14 = GameObject.Find("Toggle14").GetComponent<Toggle>();
   */
